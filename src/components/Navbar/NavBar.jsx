    ...
    <nav className="navbar navbar-expand-lg navbar-dark sticky-top" style={{ backgroundColor: "#000000" }}>
      <div className="container px-4">
        <Link className="navbar-brand" to="/">
          <span style={{ color: "#FFFFFF", fontSize: "26px", fontWeight: "bold", letterSpacing: "1px" }}>
            MercadoMágico
          </span>
        </Link>
      ...
      <span className="navbar-toggler-icon"></span>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0" style={{ fontWeight: 500 }}>
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/category/platos">PLATOS</Link>
            </li>
            <li className="nav-item">
